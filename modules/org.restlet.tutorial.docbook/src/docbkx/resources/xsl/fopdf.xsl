...
<!-- 
    ...
    This is the XSL FO (PDF) stylesheet for the Restlet Framework tutorial
    documentation.
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <!-- Logo -->
                            <fo:block>
                                <fo:external-graphic src="file:src/docbkx/resources/images/logo200.gif"/>
                            </fo:block>
    ...
    <xsl:template name="footer.content">
		...
		<xsl:variable name="Version">
			<xsl:if test="//releaseinfo">
				<xsl:text>Restlet Framework - Tutorial (</xsl:text><xsl:value-of select="//releaseinfo" /><xsl:text>)</xsl:text>
			</xsl:if>
		</xsl:variable>
        <xsl:choose>

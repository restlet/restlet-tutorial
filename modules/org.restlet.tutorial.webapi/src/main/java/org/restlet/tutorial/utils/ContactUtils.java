...
public class ContactUtils {
    ...
    public static Contact toContact(ContactRepresentation cRepr) {
        if (cRepr != null) {
    ...
    public static ContactRepresentation toContactRepresentation(Contact contact) {
    ...
    public static ContactWithCompanyRepresentation toContactWithCompanyRepresentation(
            Contact contact) {
